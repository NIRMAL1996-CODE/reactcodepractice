const Home = () => {
  return (
    ...
    <img className="w-full h-[603px]" src="https://images.unsplash.com/photo-1518655048521-f130df041f66?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="homepage"/>
      <div className="absolute top-2 m-4 text-black text-2xl w-[600px] h-[550px] bg-gray-300 p-4">
